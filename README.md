...
|:---------------------------------------------------------------------------------------------------------------------------------------------------:|-------------|:---:|:---:|
| <img src="https://user-images.githubusercontent.com/30663492/154312188-3d81ffe6-3a26-420b-9c17-7220f00a8e98.png" alt="Fit Tracker" title="Fit Tracker" width="200" /> | **Fit Tracker** <br>An Exercise Tracker App to log the exercises for a user, built with ExpressJS (APIs), React (UI) and MongoDB for database along with MongooseJS for database operations. | [Source Code](https://github.com/saideepd/exercise-tracker "View Source Code on GitHub for Fit Tracker") | [Fit Tracker](https://fittracker.netlify.app/ "View Fit Tracker's demo") |
