...
|:---------------------------------------------------------------------------------------------------------------------------------------------------:|-------------|:---:|:---:|
| <img src="https://i.imgur.com/dIzCoTf.png" alt="Timestamp API" title="Timestamp Microservice API" width="200" /> | **Timestamp Microservice API** <br>A Timestamp Microservice API built using Express JS which parses the input date and returns the UNIX and UTC timestamps for the provided input. | [Source Code](https://github.com/saideepd/timestamp-microservice "View Source Code on GitHub for Timestamp Microservice API")  | [Timestamp Microservice API](https://timestamp-microservice.saideepd.repl.co/ "View Timestamp Microservice API's demo") |
