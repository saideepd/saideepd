...
|:---------------------------------------------------------------------------------------------------------------------------------------------------:|-------------|:---:|:---:|
| <img src="https://user-images.githubusercontent.com/30663492/150652568-86007c2a-663a-417a-81c0-2c69b71fb1f4.png" alt="Microservice Utility API" title="Microservice Utility API" width="200" /> | **Microservice Utility API** <br>It is a set of different Microservice APIs built using Express JS & MongoDB which serve different purpose like providing Timestamp in UNIX and UTC formats, Request Header parsing to provide client info, Shortening lengthy URL for ease to use. | [Source Code](https://github.com/saideepd/microservice-utility "View Source Code on GitHub for Microservice Utility API")  | [Microservice Utility API](https://microservice-utility.netlify.app/ "View Microservice Utility API's demo") |
